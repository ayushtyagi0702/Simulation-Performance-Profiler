...
COLOR_PROMPT="\e[1;38;5;82m"                  # Bold, Green-ish (82)        
...
RTL_DIR="/home/ayush07/project1/rtl"
TB_DIR="/home/ayush07/project1/testbench"
LOG_DIR="/home/ayush07/project1/logs"
...
while true; do
    ...
    echo "1) Complexity of the code"
    echo "2) Stimulation Time"
    echo "3) Overall Report"
    echo "4) Most Complex File"
    echo "q) Quit"
    ...
    for rtl_file in "$RTL_DIR"/*.sv ; do
        ...
        if [[ -f "$tb_file" ]] ; then
            ...
            awk -f /home/ayush07/project1/awk1.awk "$rtl_file" > "$SIGNALS_REPORT"
            ...
            awk -f /home/ayush07/project1/instance.awk "$rtl_file" > "$INSTANCE_FILE"
